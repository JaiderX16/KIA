      ...
      <div className="w-full max-w-[420px] flex flex-col">
        ...
        <div className="space-y-4 mb-8">
          <div className="relative group">
            ...
            <input type="email" placeholder="Correo institucional" className="w-full pl-12 pr-4 py-4 md:py-5 bg-white/50 dark:bg-[#1c1c1e]/50 backdrop-blur-sm border border-white/80 dark:border-white/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:bg-white/80 dark:focus:bg-[#1c1c1e]/80 transition-all shadow-sm text-gray-700 dark:text-white" defaultValue="74094447@continental.edu.pe"/>
          </div>
          <div className="relative group">
