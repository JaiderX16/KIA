...
import { ChevronLeft, Leaf, Droplet, Trash2, FileText } from 'lucide-react';
...
const AnalysisScreen = ({ navigate }) => (
  <div className="min-h-full flex flex-col w-full">
    <div className="flex items-center px-6 pt-16 md:pt-10 pb-4 bg-white/60 backdrop-blur-xl border-b border-white/50 sticky top-0 z-20">
      ...
      <h2 className="flex-1 text-center font-extrabold text-lg md:text-xl text-gray-800">Analizando...</h2>
      <div className="w-10 flex justify-end"><Leaf className="text-emerald-500 animate-pulse" size={20} /></div>
    </div>
    ...
    <div className="p-6 md:p-10 flex-1 flex flex-col md:flex-row gap-8 md:gap-12 max-w-[1200px] mx-auto w-full">
      <div className="flex-1 w-full flex flex-col">
        ...
        <div className="relative rounded-[2rem] overflow-hidden flex-1 min-h-[250px] shadow-sm border border-white bg-gray-100 group">
          ...
          />
          <div className="absolute top-6 right-6 bg-white/90 backdrop-blur-md text-blue-700 text-sm md:text-base font-bold px-5 py-2.5 rounded-full shadow-lg border border-white flex items-center gap-2 transition-transform hover:scale-105">
            <div className="w-2.5 h-2.5 rounded-full bg-blue-500"></div> Botella PET x8
          </div>
          <div className="absolute bottom-16 right-8 bg-white/90 backdrop-blur-md text-yellow-700 text-sm md:text-base font-bold px-5 py-2.5 rounded-full shadow-lg border border-white flex items-center gap-2 transition-transform hover:scale-105">
            <div className="w-2.5 h-2.5 rounded-full bg-yellow-500"></div> Aluminio x5
          </div>
          <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-md text-emerald-700 text-sm md:text-base font-bold px-5 py-2.5 rounded-full shadow-lg border border-white flex items-center gap-2 transition-transform hover:scale-105">
